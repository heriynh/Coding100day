                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?php echo $idpesanan; ?>">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
                                        ...
                                        <!-- The Modal Delete -->
                                        <div class="modal fade" id="delete<?php echo $idpesanan; ?>">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="ido" value="<?= $idpesanan; ?>"><input type="hidden" name="idm" value="<?= $idmasuk; ?>">
                                                        </div>

                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" data-bs-dismiss="modal" name="hapusorder">Delete</button>
